...
@section('opciones-encabezado')
    <div class="opciones">
        <a class="btn" href="{{  URL::to('/asignatura/'.$asignatura->codigo_asignatura.'/nueva-publicacion') }}">Nueva publicacion<span class="glyphicon glyphicon-cloud-upload"></span></a>
    </div>
@stop
